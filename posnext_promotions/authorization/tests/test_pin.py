...
"""Tests for posnext_promotions.authorization.pin — hashed storage, format rules, lockout, and the
...
from posnext_promotions.authorization.tests.helpers import CASHIER, GOOD_PIN, OTHER_PIN, OUTSIDER, make_user
