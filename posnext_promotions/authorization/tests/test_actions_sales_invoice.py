...
"""Tests for posnext_promotions.authorization.actions.sales_invoice — the two shipped actions
...
from posnext_promotions.authorization import gate, registry


class TestSalesInvoiceActions(FrappeTestCase):
	def test_return_against_invoice_selects_the_return_action(self):
		from posnext_promotions.authorization.actions.sales_invoice import (
