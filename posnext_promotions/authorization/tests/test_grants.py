...
"""Tests for posnext_promotions.authorization.grants — binding and consumption rules, pure logic,
no documents.
"""
...
from posnext_promotions.authorization import grants
from posnext_promotions.authorization.tests.helpers import CASHIER, DUMMY_ACTION, MANAGER
