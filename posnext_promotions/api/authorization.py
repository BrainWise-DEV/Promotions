...
:func:`posnext_promotions.authorization.gate.enforce_document`, which runs on ``before_submit`` and
...
from posnext_promotions.authorization import gate, grants, log, policy, registry
