...
"""Tests for posnext_promotions.api.authorization — the endpoints themselves, not just the domain
...
from posnext_promotions.api.authorization import request_grant
from posnext_promotions.authorization import pin as pin_store
from posnext_promotions.authorization.tests.helpers import (
	DUMMY_ACTION,
	GOOD_PIN,
	MANAGER,
	OTHER_PIN,
