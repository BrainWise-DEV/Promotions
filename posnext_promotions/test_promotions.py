...
class TestPricingRuleScope(FrappeTestCase):
	"""Scope resolution for Pricing Rules — `posnext_promotions.promotions.scope`.
...
class TestDiscountPipeline(FrappeTestCase):
	"""The per-line accumulator in `posnext_promotions.promotions.engine`.
...
class TestAccumulativeOfflinePayload(FrappeTestCase):
	...
	def _offers_by_name(self):
		from posnext_promotions.api.offers import get_offers
