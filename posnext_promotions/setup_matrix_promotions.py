...
Usage:
    bench --site <site> execute posnext_promotions.setup_matrix_promotions.setup
    bench --site <site> execute posnext_promotions.setup_matrix_promotions.teardown
    bench --site <site> execute posnext_promotions.setup_matrix_promotions.print_guide
"""
...
Run automated matrix tests:
  bench --site <site> run-tests --app pos_next --module posnext_promotions.test_promotions
"""
	print(guide.strip())
	return guide
